...
let CommonListController = class CommonListController {
    constructor(bannerService, categoryService, productRelatedService, productService, productImageService, customerWishlistService, countryService, contactService, emailTemplateService, zoneService) {
    ...
    productList(limit, offset, keyword, manufacturerId, categoryId, priceFrom, priceTo, price, condition, count, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const productList = db.product.find();
