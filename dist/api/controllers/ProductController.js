...
let ProductController = class ProductController {
    ...
    deleteProduct(productDelete, response, request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield this.productRelatedService.delete(productDelete.productId);
            yield this.productImageService.delete(productDelete.productId);
            yield this.productToCategoryService.delete(productDelete.productId);
            if (deleteProduct) {
                const successResponse = {
                    status: 1,
                    message: 'Successfully deleted Product',
